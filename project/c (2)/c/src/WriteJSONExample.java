...
public class WriteJSONExample
{
	...
	public static void main( String[] args )
    {
		...
		regexdetails1.put("Global Dcelarations", globalregexdetails);
		regexdetails1.put("Local Dcelarations", localregexdetails);
		regexdetails1.put("Function Dcelarations", funcregexdetails);
